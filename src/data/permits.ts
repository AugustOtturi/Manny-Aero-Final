...
export const DOWNLOADS: DownloadItem[] = [
  {
    name: "How to Fill a POA",
    url: "/files/how-to-fill-a-poa.docx",
    type: "DOCX",
    icon: "document",
  },
  {
    name: "SENEAM POA Manny",
    url: "/files/seneam-poa-manny.docx",
    type: "DOCX",
    icon: "send",
  },
  {
    name: "AFAC POA",
    url: "/files/afac-poa.pdf",
    type: "PDF",
    icon: "shield",
  },
  {
    name: "Blanket Permit Checklist",
    url: "/files/blanket-permit-checklist.pdf",
    type: "PDF",
    icon: "check",
  },
  {
    name: "IBP RoadMap",
    url: "/files/ibp-roadmap.pdf",
    type: "PDF",
    icon: "plane",
  },
  {
  ...
  {
    name: "ELT Letter Example",
    url: "/files/elt-letter-example.docx",
    type: "DOCX",
    icon: "document",
  },
  {
    name: "ELT Letter Example Translation",
    url: "/files/elt-letter-example-translation.docx",
    type: "DOCX",
    icon: "document",
  },
  {
    name: "Fleet Information Example",
    url: "/files/fleet-information-example.xlsx",
    type: "XLSX",
    icon: "document",
  },
  {
    name: "Info for Insurance Purchase",
    url: "/files/info-for-insurance-purchase.xlsx",
    type: "XLSX",
    icon: "shield",
  },
];
